...
import Patterns.Behavioral.Memento.Ex2.command.ColorCommand;
import Patterns.Behavioral.Memento.Ex2.command.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                Patterns.Behavioral.Memento.Ex2.shape.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
